...
description: Aplicar convencoes operacionais, higiene de versionamento, prompts, skills, agents, catalogos, rules e regras de manutencao deste repo de dotfiles. Use quando a tarefa tocar `AGENTS.md`, `LICOES-APRENDIDAS.md`, `.agents/`, `.codex/README.md`, naming de commit/PR, worktrees, organizacao de docs, `.gitignore` ou decisao sobre versionar arquivos locais de ferramentas.
---
...
1. Ler `AGENTS.md`, `LICOES-APRENDIDAS.md` e `docs/ai-operating-model.md`.
2. Ler `references/conventions.md` desta skill.
3. Se houver reuso ou importacao de outro repo, concluir auditoria estrutural exaustiva e registrar o resultado em `docs/AI-SOURCE-AUDIT.md`.
...
6. Manter `.agents/` como fonte canonica e os catalogos, docs e gates em paridade com essa arvore.
...
- `.codex/` no repo deve permanecer apenas como ponte de compatibilidade.
- `LICOES-APRENDIDAS.md` tambem e contrato operacional e nao pode ficar fora do fluxo de fechamento.
...
- workflow de governanca quando o escopo tocar `AGENTS.md`, `.agents/`, `.codex/README.md`, `docs/TASKS.md`, `docs/WORKFLOWS.md` ou `.gitignore`
