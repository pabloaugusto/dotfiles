...
1. Ler `docs/AI-WIP-TRACKER.md`, `LICOES-APRENDIDAS.md` e, quando houver pendencias adiadas, `docs/ROADMAP.md` e `docs/ROADMAP-DECISIONS.md`.
...
6. Antes do `done`, revisar explicitamente `LICOES-APRENDIDAS.md` e registrar `capturada` ou `sem_nova_licao`.
...
- `docs/ROADMAP.md` e `docs/ROADMAP-DECISIONS.md` recebem itens adiados por `roadmap_pendente`.
- nenhum item em `Done` pode ficar sem revisao em `LICOES-APRENDIDAS.md`.
