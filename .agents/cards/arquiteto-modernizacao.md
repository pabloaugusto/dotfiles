...
- estado atual de `docs/AI-WIP-TRACKER.md`, `docs/ROADMAP.md`, `docs/ROADMAP-DECISIONS.md` e outros registradores de pendencias, backlog e trabalho feito
...
1. Ler `AGENTS.md`, `LICOES-APRENDIDAS.md` e `docs/AI-DELEGATION-FLOW.md`.
2. Ler continuamente `docs/AI-WIP-TRACKER.md`, `docs/ROADMAP.md`, `docs/ROADMAP-DECISIONS.md` e qualquer outro artefato vivo de pendencias, backlog, itens feitos e trabalhos em andamento.
