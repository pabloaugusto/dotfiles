...
Uso:
  ...
  secret inject 1pass df/secrets/dotfiles.age.local.key.tpl df/secrets/dotfiles.age.local.key

  secret keygen age df/secrets/dotfiles.age.local.key
  secret keygen age df/secrets/dotfiles.age.local.key --force

  secret ageKey df/secrets/dotfiles.age.local.key

  secret crypt sops df/secrets/local.env
  secret crypt sops df/secrets/local.env df/secrets/local.env.sops df/secrets/dotfiles.sops.yaml
  secret crypt sops df/secrets/local.env --age-key df/secrets/dotfiles.age.local.key

  secret decrypt sops df/secrets/local.env.sops
  secret decrypt sops df/secrets/local.env.sops df/secrets/local.env df/secrets/dotfiles.sops.yaml
  secret decrypt sops df/secrets/local.env.sops --age-key df/secrets/dotfiles.age.local.key
