...
# habilita LS_COLORS quando dircolors estiver disponivel.
...
# Alias definitions locais continuam suportadas em ~/.bash_aliases, mas os
# aliases canonicos versionados deste repo vivem em ~/.aliases.
...
# env vars setup
#--------------------------------------------------------------
export   ASSETS="$HOME/dotfiles/app/df/assets"
