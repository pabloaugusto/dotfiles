...
- [`app/bootstrap/_start.ps1`](./_start.ps1): menu e entrypoint do Windows host.
- [`app/bootstrap/bootstrap-windows.ps1`](./bootstrap-windows.ps1): fluxo Windows (`full`, `refresh`,
  `relink`).
- [`app/bootstrap/bootstrap-ubuntu-wsl.sh`](./bootstrap-ubuntu-wsl.sh): fluxo Ubuntu WSL (`full`, `relink`).
- [`app/bootstrap/bootstrap-config.ps1`](./bootstrap-config.ps1): parser, wizard e sincronismo da config.
...
- [`app/bootstrap/user-config.yaml.tpl`](./user-config.yaml.tpl): template versionado
...
- [`app/df/secrets/secrets-ref.yaml`](../df/secrets/secrets-ref.yaml)
- [`app/bootstrap/secrets/.env.local.tpl`](./secrets/.env.local.tpl)
...
para `git-signing.automation-public-key` em [`app/df/secrets/secrets-ref.yaml`](../df/secrets/secrets-ref.yaml),
