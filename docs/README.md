...
4. [`app/bootstrap/README.md`](../app/bootstrap/README.md)
5. [`docs/test-strategy.md`](test-strategy.md)
6. [`docs/ai-operating-model.md`](ai-operating-model.md)
7. [`SECURITY.md`](../SECURITY.md)

## Operacao do ambiente e bootstrap

- [`docs/bootstrap-flow.md`](bootstrap-flow.md): fluxograma detalhado do bootstrap Windows, WSL,
  OneDrive e gates.
- [`docs/checkenv.md`](checkenv.md): contrato e checklist do `checkEnv`.
- [`docs/config-reference.md`](config-reference.md): referencia comentada do YAML de bootstrap.
- [`docs/onedrive.md`](onedrive.md): layout, migracao e troubleshooting do OneDrive.
- [`docs/secrets-and-auth.md`](secrets-and-auth.md): modelo de segredos, auth e runtime cifrado.
...
- [`docs/user-home-structure.md`](user-home-structure.md): layout esperado do `HOME` apos bootstrap.
- [`app/bootstrap/README.md`](../app/bootstrap/README.md): guia operacional textual do bootstrap.

## Qualidade, testes e CI/CD

- [`docs/test-strategy.md`](test-strategy.md): arquitetura de testes do repo.
- [`docs/TASKS.md`](TASKS.md): catalogo das tasks canonicas mais importantes.
- [`docs/WORKFLOWS.md`](WORKFLOWS.md): catalogo dos workflows ativos e suas tasks.
...
- [`docs/repo-audit.md`](repo-audit.md): snapshot atual de riscos, achados resolvidos e backlog
...
- [`docs/AI-AGENTS-CATALOG.md`](AI-AGENTS-CATALOG.md): catalogo dos agentes do repo.
- [`docs/AI-SKILLS-CATALOG.md`](AI-SKILLS-CATALOG.md): catalogo das skills.
- [`docs/AI-DELEGATION-FLOW.md`](AI-DELEGATION-FLOW.md): fluxo de intake, roteamento e delegacao.
- [`docs/AI-GOVERNANCE-AND-REGRESSION.md`](AI-GOVERNANCE-AND-REGRESSION.md): regressao e governanca da camada de IA.
...
- [`docs/AI-BACKLOG-LIVE-AUDIT.md`](AI-BACKLOG-LIVE-AUDIT.md): matriz auditavel do backlog vivo versus `Jira`, incluindo backfill de owners oficiais.
- [`docs/AI-DONE-ISSUES-AUDIT.md`](AI-DONE-ISSUES-AUDIT.md): baseline versionada da auditoria integral das issues em **Done**, com checklist por onda, veredicto formal e remediacoes de paridade terminal.
- [`docs/AI-PAUSED-ISSUES-AUDIT.md`](AI-PAUSED-ISSUES-AUDIT.md): classificacao factual das issues em **Paused**, com evidencias, veredicto e acao recomendada por item.
- [`docs/AI-RETROSPECTIVE-BACKFILL-AUDIT.md`](AI-RETROSPECTIVE-BACKFILL-AUDIT.md): inventario versionado das branches encerradas, com cobertura existente, backfill fiel e excecoes documentadas de retrospectiva.
- [`docs/AI-SOURCE-AUDIT.md`](AI-SOURCE-AUDIT.md): auditoria estrutural das fontes cross-repo.
- [`docs/git-conventions.md`](git-conventions.md): convencoes de branch, commit e PR.

## Referencias e notas

- [`docs/reference/powershell/`](reference/powershell/): referencias tecnicas auxiliares.
- [`docs/notes/`](notes/): notas de uso pontual que nao sao contratos principais.

## Regra de manutencao

- README raiz = catalogo funcional do projeto.
- [`docs/TASKS.md`](TASKS.md) e [`docs/WORKFLOWS.md`](WORKFLOWS.md) devem refletir a automacao real.
- [`app/bootstrap/README.md`](../app/bootstrap/README.md) e [`tests/README.md`](../tests/README.md) devem refletir os fluxos correntes,
