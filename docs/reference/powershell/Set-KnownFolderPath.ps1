# https://github.com/Mauvlans/OneDrive/blob/master/Intune-SchedTsk-KFR-AllKnownFolders.ps1
function Set-KnownFolderPath {
	...
	if (-not $Type) {
		$Signature = @' [DllImport("shell32.dll")] public extern static int SHSetKnownFolderPath(ref Guid folderId, uint flags, IntPtr token, [MarshalAs(UnmanagedType.LPWStr)] string path);'@
