...
| --- | --- | --- | --- | --- | --- |
| CHAT-001 | Formalizar o **Scrum Master** como agente de enforcement continuo de governanca, fiscalizacao do board, logs de inconformidade e cobranca de aderencia de todos os agentes. | Busca textual da auditoria DOT-116 nao encontrou regra operacional vigente para `Scrum Master` em [`AGENTS.md`](../AGENTS.md), [`docs/ai-operating-model.md`](ai-operating-model.md), [`config/`](../config/) ou [`.agents/`](../.agents/). | [DOT-115: Criar agente de enforcement continuo de governanca](https://pabloaugusto.atlassian.net/browse/DOT-115) e [DOT-124: Formalizar log perene de inconformidades e cerimonias do Scrum Master](https://pabloaugusto.atlassian.net/browse/DOT-124) | cards, registry, docs operacionais, log versionado e control plane | pendente |
...
| CHAT-004 | Ler o **board** da direita para a esquerda, priorizar terminar antes de comecar e puxar novo trabalho so depois de tentar destravar o que esta mais perto do fim. | Busca textual da auditoria DOT-116 nao encontrou a regra operacional explicitada com essa formulacao em [`AGENTS.md`](../AGENTS.md), [`docs/ai-operating-model.md`](ai-operating-model.md) ou [`config/ai/contracts.yaml`](../config/ai/contracts.yaml). | [DOT-119: Formalizar leitura do board da direita para a esquerda e foco em terminar antes de começar](https://pabloaugusto.atlassian.net/browse/DOT-119) | contratos do board, docs operacionais e regras do control plane | pendente |
...
| CHAT-006 | Formalizar **cerimonias** ageis versionadas, com schema, logs em Markdown e rastreabilidade em `Confluence`, com **retrospectiva** obrigatoria ao fim de cada branch fechada. | Busca textual da auditoria DOT-116 encontrou referencias conceituais em [`docs/atlassian-ia/2026-03-08-manual-agilidade-control-plane.md`](atlassian-ia/2026-03-08-manual-agilidade-control-plane.md), mas nao encontrou contrato operacional ativo em [`.agents/`](../.agents/), [`AGENTS.md`](../AGENTS.md) ou [`config/`](../config/). | issue ainda nao criada nesta auditoria | evolucao da camada [`.agents/`](../.agents/), contratos, logs e sync com `Confluence` | pendente |
