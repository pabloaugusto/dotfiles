...
- aliases centralizados por ambiente:
  - [`app/df/.aliases`](../app/df/.aliases)
  - [`app/df/powershell/aliases.ps1`](../app/df/powershell/aliases.ps1)
  - [`app/df/git/.gitconfig-base`](../app/df/git/.gitconfig-base)
...
1. **Politica Git global insegura (`safe.directory = *`)**
   - Evidencia: [`app/df/git/.gitconfig`](../app/df/git/.gitconfig)
...
1. **Menu do `_start.ps1` ainda expoe Linux/Mac sem dispatch real**
   - Evidencia: [`docs/bootstrap-flow.md`](bootstrap-flow.md) e [`app/bootstrap/_start.ps1`](../app/bootstrap/_start.ps1)
...
2. **Scripts legados de suporte ainda usam comandos quebrados**
   - Evidencia: [`app/bootstrap/scripts/post-win-install-script.ps1`](../app/bootstrap/scripts/post-win-install-script.ps1)
...
3. **Catalogo de software Windows ainda tem ruido e fragilidade**
   - Evidencia: [`app/bootstrap/software-list.ps1`](../app/bootstrap/software-list.ps1)
   - Exemplos:
...
1. **Plugin do `op` no Bash pode alterar comandos esperados**
   - Evidencia: [`app/df/bash/.bashrc`](../app/df/bash/.bashrc)
...
2. **Instalacao apt ainda usa heuristica fragil**
   - Evidencia: [`app/df/bash/.inc/_functions.sh`](../app/df/bash/.inc/_functions.sh)
...
3. **`checkEnv` Bash ainda usa temporarios previsiveis em partes do fluxo**
   - Evidencia: [`app/df/bash/.inc/check-env.sh`](../app/df/bash/.inc/check-env.sh)
...
4. **Decrypt de `.env.local.sops` em toda abertura de shell**
   - Evidencia: [`app/df/bash/.bashrc`](../app/df/bash/.bashrc), [`app/df/bash/.profile`](../app/df/bash/.profile)
...
5. **Scripts legados ainda precisam de marcacao mais explicita**
   - Evidencia: [`app/bootstrap/symlinks.ps1`](../app/bootstrap/symlinks.ps1) e o legado historico sob [`../archive/`](../archive/)
...
- fixtures dentro de [`app/df/`](../app/df/): resolvido
...
3. Modularizar [`app/bootstrap/software-list.ps1`](../app/bootstrap/software-list.ps1).
