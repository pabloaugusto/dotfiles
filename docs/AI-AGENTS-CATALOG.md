...
| Pascoalete | [`.agents/cards/pascoalete.md`](../.agents/cards/pascoalete.md) | alias local `pascoalete` do `ai-linguistic-reviewer` | `$dotfiles-orthography-review` | ortografia tecnica, higiene vocabular, curadoria de `cspell` e pendencia consultiva quando houver falha textual nao corrigida |
...
| Pascoalete | [`.agents/cards/ai-linguistic-reviewer.md`](../.agents/cards/ai-linguistic-reviewer.md) | `ai-linguistic-reviewer` | `$dotfiles-orthography-review` | revisao linguistica oficial, terminologia, microcopy e higiene de `cspell` |
| Escrivao | [`.agents/cards/ai-documentation-writer.md`](../.agents/cards/ai-documentation-writer.md) | `ai-documentation-writer` | `$dotfiles-repo-governance` | escrita, reescrita e consolidacao documental sob demanda |
| Revisor Documental | [`.agents/cards/ai-documentation-reviewer.md`](../.agents/cards/ai-documentation-reviewer.md) | `ai-documentation-reviewer` | `$dotfiles-repo-governance` | completude, utilidade, seguranca de uso e severidade documental |
| Gestor Documental | [`.agents/cards/ai-documentation-manager.md`](../.agents/cards/ai-documentation-manager.md) | `ai-documentation-manager` | `$dotfiles-repo-governance` | source of truth, placement, lifecycle, deduplicacao e elegibilidade de sync |
| Sync Documental | [`.agents/cards/ai-documentation-sync.md`](../.agents/cards/ai-documentation-sync.md) | `ai-documentation-sync` | `$dotfiles-critical-integrations` | publication, backlinks, `documentation-link` e rastreabilidade cross-surface |
| Escrivao (legado) | [`.agents/cards/ai-documentation-agent.md`](../.agents/cards/ai-documentation-agent.md) | `ai-documentation-agent` | `$dotfiles-repo-governance` | compatibilidade historica e decomposicao formal do papel documental antigo |
