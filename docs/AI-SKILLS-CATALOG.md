...
| --- | --- | --- |
| `$dotfiles-bootstrap` | Bootstrap, relink, config de usuario e paridade Windows/WSL | [`bootstrap/`](bootstrap/), links, paths canonicos |
...
| `$wip-continuity-governance` | Continuidade, Doing/Done, roadmap e fechamento | [`docs/AI-WIP-TRACKER.md`](docs/AI-WIP-TRACKER.md), [`docs/ROADMAP.md`](docs/ROADMAP.md), [`docs/ROADMAP-DECISIONS.md`](docs/ROADMAP-DECISIONS.md) |
