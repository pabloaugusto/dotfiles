...
class ValidateAiAssetsTests(unittest.TestCase):
    def test_validator_exports_new_governance_contracts(self) -> None:
        ...
        self.assertIn("config/config.toml", module.REQUIRED_FILES)
        self.assertIn("config/dev.toml", module.REQUIRED_FILES)
        self.assertIn("config/integrations.toml", module.REQUIRED_FILES)
        self.assertIn("config/quality.toml", module.REQUIRED_FILES)
        self.assertIn("config/schema.json", module.REQUIRED_FILES)
        self.assertIn("config/time-surfaces.yaml", module.REQUIRED_FILES)
        self.assertIn("app/config/config.toml", module.REQUIRED_FILES)
        self.assertIn("app/config/runtime.toml", module.REQUIRED_FILES)
        self.assertIn("app/config/bootstrap.toml", module.REQUIRED_FILES)
        self.assertIn("app/config/links.toml", module.REQUIRED_FILES)
        self.assertIn("app/config/schema.json", module.REQUIRED_FILES)
        self.assertIn(".agents/config/config.toml", module.REQUIRED_FILES)
        self.assertIn(".agents/config/agents.toml", module.REQUIRED_FILES)
        self.assertIn(".agents/config/communication.toml", module.REQUIRED_FILES)
        ...
        self.assertIn(".agents/config/reviews.toml", module.REQUIRED_FILES)
        self.assertIn(".agents/config/prompts.toml", module.REQUIRED_FILES)
        self.assertIn(".agents/config/schema.json", module.REQUIRED_FILES)
        self.assertIn(".agents/config/migration-matrix.yaml", module.REQUIRED_FILES)
        ...
        self.assertIn("scripts/ai-atlassian-actor.py", module.REQUIRED_FILES)
        self.assertIn("scripts/ai-atlassian-actor-backfill.py", module.REQUIRED_FILES)
        ...
        self.assertIn("scripts/ai_atlassian_actor_lib.py", module.REQUIRED_FILES)
        self.assertIn("scripts/ai_atlassian_actor_backfill_lib.py", module.REQUIRED_FILES)
        ...
        self.assertIn("scripts/ai_atlassian_seed_lib.py", module.REQUIRED_FILES)
        self.assertIn("scripts/atlassian_platform_lib.py", module.REQUIRED_FILES)
        self.assertIn("scripts/config_context_lib.py", module.REQUIRED_FILES)
        self.assertIn("scripts/config_context_docs_lib.py", module.REQUIRED_FILES)
        self.assertIn("scripts/generate-config-context-docs.py", module.REQUIRED_FILES)
        ...
        self.assertIn("project", module.REQUIRED_ROOT_CONFIG_SECTIONS)
        self.assertIn("context", module.REQUIRED_APP_CONFIG_SECTIONS)
        self.assertIn("context", module.REQUIRED_AI_CONTEXT_SECTIONS)
        self.assertIn(
