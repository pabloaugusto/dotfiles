...
class AiSessionStartupTests(unittest.TestCase):
    ...
    def _fake_active_execution() -> dict[str, object]:
        return {
            ...
            "agent": "Engenheiro Agentes IA",
            "agent_id": "ai-developer-config-policy",
            "agent_display_name": "Engenheiro Agentes IA",
            "workflow_status": "doing",
            "current_agent_role": "Engenheiro Agentes IA",
            "current_agent_role_id": "ai-developer-config-policy",
            "next_required_role": "Tech Lead",
            "next_required_role_id": "ai-tech-lead",
            "branch": "feat/DOT-177-startup-preflight-memory",
