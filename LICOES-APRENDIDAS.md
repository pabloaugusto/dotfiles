...
- Solucao validada: Criar scripts/run-ai-worklog-update.ps1 com parametros PowerShell seguros e repasse deterministico do array de argumentos para invoke-python.ps1.
